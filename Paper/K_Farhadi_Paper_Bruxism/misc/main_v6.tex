...
\begin{figure}[t]
  \centering
  \raisebox{0.03\height}{\includegraphics[width=0.795\linewidth]{Figures/patient_new.png}}\hfill
  \caption{The study. (a) Sensor placement: bipolar surface-EMG pairs over the temporalis (EMG-T) and masseter (EMG-M), with a microphone (MIC) near the temporomandibular joint as an annotation aid; it is not analysed, for the measured reasons in Section~\ref{sec:mic}.}
  \label{fig:setup}
\end{figure}
